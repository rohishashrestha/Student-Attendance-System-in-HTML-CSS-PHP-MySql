                ...
                <div class="card-display">
                    ...
                    <div class="dcard d2">
                        ...
                        <ul class="dlist">
                            <li class="dleft">
                                <?php
                                    $query = mysqli_query($conn, "SELECT * from tblclass");
                                    $class = mysqli_num_rows($query);

                                    echo $class;
                                ?>
                            </li>
                            <li class="dright text-right"><i class="material-icons">book</i></li>
                        </ul>
                    </div>
                    <div class="dcard d3">
                        <h5>Lecturers</h5>
                        <ul class="dlist">
                            ...
                            <li class="dright text-right"><i class="material-icons">group</i></li>
                        </ul>
                    </div>
                    <div class="dcard d4">
                        <h5>Semester</h5>
